...
|-----------|------|-------------|----------|
| gRPC | 50051 | none (always on) | mesh routing, programmatic access |
...
The gRPC server and core engine are always compiled -- no feature flag needed for library consumers or for gRPC integration.
